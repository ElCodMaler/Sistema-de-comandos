...
class Lista_Comandos:
    def __init__(self):
        self.comandos = [Comando(1,'cd','Acceso al directorio.',['cd',None]),
                         ...
                         Comando(3,'mkdir','Crear Carpetas en el directorio actual.',['mkdir']),
                         Comando(4,'rmdir','Eliminar carpetas vacias del directorio actual',['rmdir']),
                         ...
                         Comando(7,'type','Mostrar el contenido del archivo con su ubicacion.',['type',None,None]),
                         Comando(8,'help','Mostrar los comandos disponibles.',['help']),
                         Comando(9,'exit','Finalizar programa.',['exit'])]